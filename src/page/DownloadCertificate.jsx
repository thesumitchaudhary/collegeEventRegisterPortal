...
// importing image
import HeaderImage from "../images/otherPageHeaderImage.avif";
...
export default function DownloadCertificate() {
  ...
  const handleSearch = async () => {
    ...
    const { data, error } = await supabase
      .from("certificates")
      .select("*")
      .or(`email.eq.${input},reg_id.eq.${input}`)
      .single();
  ...
  return (
    <div className="relative">
      <img className="absolute -z-10  h-[10rem] w-full" src={HeaderImage} alt="" />
      ...
      <main className="bg-[#000] h-100 grid place-items-center">
        <div className="max-w-xl mx-auto mt-16 p-4 border rounded-xl shadow">
